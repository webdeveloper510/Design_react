...
var SimpleImageSlider = function SimpleImageSlider(_ref3) {
  ...
  var _React$useState3 = React.useState(styles.getImageSlide(images[0].url, slideDuration, 0, useGPURender)),
      _React$useState4 = _slicedToArray(_React$useState3, 2),
      currentSliderStyle = _React$useState4[0],
      setCurrentSlideStyle = _React$useState4[1];

  var _React$useState5 = React.useState(styles.getImageSlide((_images$ = images[1]) === null || _images$ === void 0 ? void 0 : _images$.url, slideDuration, 1, useGPURender)),
  ...
  React.useEffect(function () {
    ...
    var currentUrl = images[getNextLoopingIdx(isRightDirection ? slideIdx - 1 : slideIdx + 1)].url;
  ...
  var handleSlideEnd = React.useCallback(function () {
    ...
    ImageSliderPreLoader.load((_images = images[slideIdx + 2]) === null || _images === void 0 ? void 0 : _images.url);
