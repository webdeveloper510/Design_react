 ...
 * @param horizontal If true, scroll will be horizontal
 * @param callback Callback when scroll position is reached
 */
export declare function smoothScroll(elm: HTMLElement, to: number, animate?: boolean, horizontal?: boolean, rtl?: boolean, callback?: () => void): void;
/**
