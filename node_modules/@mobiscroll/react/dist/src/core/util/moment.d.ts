...
export declare class MDate implements IDate {
    ...
    getUTCMonth(): any;
    getUTCSeconds(): any;
    setMilliseconds(ms: number): any;
    setSeconds(sec: number, ms?: number): any;
    setMinutes(min: number, sec?: number, ms?: number): any;
    setHours(hours: number, min?: number, sec?: number, ms?: number): any;
